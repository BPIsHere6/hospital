package cn.pan.test.controller;
...
public class StudentController {
    ...
    public Result<IPage<Student>> getByPage(@ModelAttribute Student student ,@ModelAttribute PageVo page){
        ...
        if(!PanNullUtils.isNull(student.getName())) {
            qw.like("name",student.getName());
        }
        if(!PanNullUtils.isNull(student.getNumber())) {
            qw.like("number",student.getNumber());
        }
        if(!PanNullUtils.isNull(student.getSex())) {
            qw.like("sex",student.getSex());
        }
        if(!PanNullUtils.isNull(student.getSchool())) {
