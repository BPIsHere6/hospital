...
public class PanDateUtils {
     ...
     * @return 2021-11
     */
    public static String getpanNowMouth() {
        Date date = new Date();
     ...
     * @return 2021-10
     */
    public static String getpanLastMouth() {
        Date date = new Date();
        int year = date.getYear() + 1900;
        int month = date.getMonth() + 1;
        if(month > 1) {
     ...
     * 返回已过天数
     */
    public static int getpanInTimeDaySize(String date) {
        if(PanNullUtils.isNull(date)) {
            return -1;
        }
    ...
    public static String getBirthday(String idcard){
        if(idcard == null || PanNullUtils.isNull(idcard) || idcard.length() < 17)
            return null;
     ...
     * @return
     */
    public static long getpanNowCuo() {
     ...
     * @return
     */
    public static String getpanNowTime() {
        Date date = new Date();
        int hour = date.getHours();
        int minutes = date.getMinutes();
        int seconds = date.getSeconds();
     ...
     * @return
     */
    public static long panDateToCuo(String s){
        s += " 00:00:00";
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        try {
