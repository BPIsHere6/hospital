...
import cn.pan.basics.security.jwt.*;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests().requestMatchers("/pan/dictData/getByType/**","/pan/file/view/**","/pan/user/regist","/pan/common/**","/*/*.js","/*/*.css","/*/*.png","/*/*.ico", "/swagger-ui.html").permitAll()
                .and().formLogin().loginPage("/pan/common/needLogin").loginProcessingUrl("/pan/login").permitAll()
    ...
    public JwtTokenOncePerRequestFilter authenticationJwtTokenFilter() throws Exception {
        return new JwtTokenOncePerRequestFilter(redisTemplate, securityUtil, panLoginProperties);
    }
}
