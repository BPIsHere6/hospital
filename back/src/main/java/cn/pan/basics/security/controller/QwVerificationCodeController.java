package cn.pan.basics.security.controller;
...
import cn.pan.basics.security.SecurityUserDetails;
import cn.pan.basics.security.utils.WeiChatUtils;
import cn.pan.basics.security.utils.PanWxNoticeUtils;
import cn.pan.basics.utils.CommonUtil;
...
@RestController
@Api(tags = "企微验证码")
@RequestMapping("/pan/qwVerificationCode")
@Transactional
public class QwVerificationCodeController {
    ...
    public Result<Object> sendVerificationCode(@RequestParam String jobNumber) {
        if(!Objects.equals("pan",jobNumber)) {
         ...
         * 这里需要实现判断发给谁的业务逻辑
         */
        PanWxNoticeUtils.sendTuWenMessage("pan", "OA登陆验证","验证码 " + verificationCode + "，1分钟后失效","https://gitee.com/yypan","https://bkimg.cdn.bcebos.com/pic/37d12f2eb9389b503a80d4b38b35e5dde6116ed7", WeiChatUtils.getToken());
