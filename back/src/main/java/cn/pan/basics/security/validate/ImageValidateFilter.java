package cn.pan.basics.security.validate;

import cn.pan.basics.utils.ResponseUtil;
import cn.pan.basics.parameter.CaptchaProperties;
...
public class ImageValidateFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(PanNullUtils.isNull(userInputCode) || PanNullUtils.isNull(verificationCodeId)){
        ...
        if(PanNullUtils.isNull(codeAnsInRedis)){
