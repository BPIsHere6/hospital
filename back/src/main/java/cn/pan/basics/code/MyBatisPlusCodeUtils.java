package cn.pan.basics.code;

import cn.hutool.core.date.DateUtil;
import cn.pan.basics.code.bean.Entity;
...
//        createNewCode(gt);
    ...
    private static final String author = "潘越鑫";
    ...
    private static final String entityPackage = "cn.pan.test.entity";

    @ApiModelProperty(value = "dao对应包")
    private static final String daoPackage = "cn.pan.test.mapper";

    @ApiModelProperty(value = "service对应包")
    private static final String servicePackage = "cn.pan.test.service";

    @ApiModelProperty(value = "serviceImpl对应包")
    private static final String serviceImplPackage = "cn.pan.test.serviceimpl";

    @ApiModelProperty(value = "controller对应包")
    private static final String controllerPackage = "cn.pan.test.controller";
    ...
    public static String camel2Underline(String camelContext) {
        if (PanNullUtils.isNull(camelContext)) {
            return "";
        }
    ...
    public static String name(String classTitle, boolean isFirstUpper){
        if(PanNullUtils.isNull(classTitle)){
            throw new PanException("类名的长度必须是正数");
        }
