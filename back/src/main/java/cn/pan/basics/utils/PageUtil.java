...
public class PageUtil {
    ...
    public static Pageable initPage(PageVo page){
        ...
        if(!PanNullUtils.isNull(sort)) {
            Sort.Direction direction = PanNullUtils.isNull(order) ? Sort.Direction.DESC : Sort.Direction.valueOf(order.toUpperCase());
    ...
    public static String camel2Underline(String underlineContent) {
        if (PanNullUtils.isNull(underlineContent)) {
            return NULL_STR;
        }
