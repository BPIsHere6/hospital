<template>
  <div class="search">
    ...
    <Modal
      title="读取后端字段"
      v-model="findBackFieldModal"
      :width="800"
      @on-ok="submitEntityData"
    >
      <Form
        ref="entityForm"
        :model="entityForm"
        ...
        >
          ...
          >
            <Input
              ...
              placeholder="例如：cn.pan.modules.base.entity.User"
              clearable
              style="width:410px"
            />
            <Button
